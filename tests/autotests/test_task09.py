...
try:
    from project.task6_hellings_cfpq_wcnf import hellings_based_cfpq
    from project.task7_matrix_based_cfpq import matrix_based_cfpq
    from project.task8_tensor_based_cfpq import tensor_based_cfpq, cfg_to_rsm, ebnf_to_rsm
    from project.task9_gll_based_cfpq import gll_based_cfpq
except ImportError:
